...
import (
	...
	"practice/webook/internal/service/oauth2/wechat"
...
func NewOAuth2WechatHandler(svc wechat.Service, userSvc service.UserService, cfg WechatHandlerConfig, jwtHdl ijwt.Handler) *OAuth2WechatHandler {
	return &OAuth2WechatHandler{
		...
		userSvc:  userSvc,
		Handler:  jwtHdl,
		stateKey: []byte("mH0fKRn8a5KPda0fSWItFyVrjrkbN9gWM"),
		cfg:      cfg,
	}
}
...
func (h *OAuth2WechatHandler) setStateCookie(ctx *gin.Context, state string) error {
	...
	ctx.SetCookie("jwt-state", tokenStr, 600, "/oauth2/wechat/callback", "", h.cfg.Secure, true) // 生产环境 secure 要设置成 true
	return nil
}
...
//另外一种实现方式
//type OAuth2Handler struct { // 支持多种登录方式：微信、钉钉、飞书
//	wechatService
//	dingdingService
//	feishuService
//
//	svc map[]OAuth2Service
//}
...
//	g.Any("/:platform/callback", h.AuthURL)
//}
