...
//
//	mockgen.exe -package=redismocks -destination=D:\gopath\src\webook_go\webook\internal\repository\cache\redismocks\cmdable.mock.go github.com/redis/go-redis/v9 Cmdable
//
